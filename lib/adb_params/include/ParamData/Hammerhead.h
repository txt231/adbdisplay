...
namespace Params::Hammerhead
{
	static const constexpr ParamInfo Hammerhead_Rev_3[] = {
		...
		ParamInfo("save",  11, 0, 255, 0, 0x0000),

		ParamInfo("dflt",  13, 0,   0, 0, 0x0000),
		ParamInfo("over",  14, 0,   0, 0, 0x0000),
		ParamInfo("cmod",  15, 0,   5, 0, 0x0000),
		ParamInfo("cont",  16, 0, 221, 0, 0x0003),
		ParamInfo("brgt",  17, 0, 254, 0, 0x0003),
		ParamInfo("hcon",  18, 0, 254, 0, 0x0003),
		ParamInfo("vcon",  19, 0, 254, 0, 0x0003),
		ParamInfo("rot ",  20, 0,  63, 0, 0x0003),

		ParamInfo("keys",  22, 0,  63, 0, 0x0003),
		ParamInfo("hwid",  23, 0, 254, 0, 0x0003),
		ParamInfo("hpos",  24, 0, 254, 0, 0x0003),
		ParamInfo("vhgt",  25, 0, 254, 0, 0x0003),
		ParamInfo("vpos",  26, 0,  63, 0, 0x0003),
		ParamInfo("pinc",  27, 0, 254, 0, 0x0003),
		ParamInfo("rgan",  28, 0, 254, 0, 0x0000),
		ParamInfo("ggan",  29, 0, 254, 0, 0x0000),
		ParamInfo("bgan",  30, 0, 254, 0, 0x0000),
		ParamInfo("rg1 ",  31, 0, 254, 0, 0x0000),
		ParamInfo("bg1 ",  32, 0, 254, 0, 0x0000),
		ParamInfo("gg1 ",  33, 0, 254, 0, 0x0000),
		ParamInfo("para",  34, 0,  63, 0, 0x0003),
		ParamInfo("bow ",  35, 0,  63, 0, 0x0003),
		ParamInfo("g2g2",  36, 0, 254, 0, 0x0000),
	...
	static const constexpr ParamInfo Hammerhead_Rev_4[] = {
		...
		ParamInfo("e2dt",   9, 0, 255, 0, 0x0000),
		ParamInfo("kcod",  10, 0,   1, 0, 0x0000),
		ParamInfo("save",  11,85, 170, 0, 0x0000), // range updated on newer macos
